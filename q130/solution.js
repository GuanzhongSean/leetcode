...
function solve(board) {
    ...
    while (queue.length > 0) {
        var _c = __read(queue.shift(), 2), x = _c[0], y = _c[1];
        var directions = [
            [0, 1],
            [0, -1],
            [1, 0],
        ...
        try {
            for (var directions_1 = (e_1 = void 0, __values(directions)), directions_1_1 = directions_1.next(); !directions_1_1.done; directions_1_1 = directions_1.next()) {
                var _d = __read(directions_1_1.value, 2), dx = _d[0], dy = _d[1];
                var nx = x + dx;
                var ny = y + dy;
    ...
    try {
        for (var O_positions_1 = __values(O_positions), O_positions_1_1 = O_positions_1.next(); !O_positions_1_1.done; O_positions_1_1 = O_positions_1.next()) {
            var _e = __read(O_positions_1_1.value, 2), x = _e[0], y = _e[1];
            board[x][y] = "O";
        }
    }
        ...
        try {
            if (O_positions_1_1 && !O_positions_1_1.done && (_b = O_positions_1.return)) _b.call(O_positions_1);
        }
